...
This script will first install the packages, in case the packages aren't already install on the system : data.table; reshape2.

The script will then load the following libraries: data.table; reshape2.
...
The script will perform a series of modifications to the columns names of the table "meanAndStd": ?Converte all "-" into "_";
Removing "()";
